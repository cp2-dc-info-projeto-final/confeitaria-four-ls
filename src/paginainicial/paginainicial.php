    ...
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">Confeitaria Four'ls</a>
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item mx-0 mx-lg-1">
            <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="../paginacliente/carrinho/carrinho.php">Meu carrinho</a>
          </li>
          <li class="nav-item mx-0 mx-lg-1">
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-4 ml-auto">
          <p class="lead">Nós da confeitaria Four L’s temos um grande reconhecimento sobre os nossos produtos na região metropolitana do Rio de Janeiro e visamos desenvolver produtos de qualidade para nossos clientes, e que desde 2016 trazemos delícias com amor e carinho para nosso público.</p>
        </div>
